...
namespace VirtualAssistantTemplate.Dialogs.Main
{
    public class MainDialog : RouterDialog
    {
        ...
        protected override async Task CompleteAsync(DialogContext innerDc, DialogTurnResult result = null, CancellationToken cancellationToken = default(CancellationToken))
        {
